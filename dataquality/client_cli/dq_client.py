...
class DQClient:
    ...
    def check(self, name, wait=None, auth_user=None, auth_password=None):
        return self._send_dq_txn(
            name,
            "check",
            wait=wait,
    ...
    def list(self, auth_user=None, auth_password=None):
        dq_prefix = self._get_prefix()

        result = self._send_request(
            "state?address={}".format(dq_prefix),
            auth_user=auth_user,
            auth_password=auth_password)
